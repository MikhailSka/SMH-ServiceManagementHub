...
class Unit_location_view(db.Model):
    ...
    def __init__(self, id, description, unit_id, unit_name, location_name_id, location_name, customer_location_id, customer_location_name, creation_date, modification_date):
        self.id = id
    ...
    def __init__(self, description, unit_id, unit_name, location_name_id, location_name, customer_location_id, customer_location_name, creation_date, modification_date):
        self.description = description
        self.unit_id - unit_id
        self.unit_name = unit_name
        self.location_name_id = location_name_id
