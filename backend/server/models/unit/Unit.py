...
class Unit(db.Model):
    ...
    def __init__(self, id, active, name, serial_number, product_code, device_id, operator_id, description, creation_date, modification_date):
        self.id = id
        self.name = name
        self.active = active
    ...
    def __init__(self, active, name, serial_number, product_code, device_id, operator_id, description, creation_date, modification_date):
        self.name = name
        self.active = active
        self.serial_number = serial_number
        self.product_code = product_code
